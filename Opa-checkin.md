...
## Phase 0 – Setup (aktuell)
# - [ ] Projektname final festlegen (Vorschlag: „Opa-Checkin" – bitte bestätigen oder Alternative nennen)
# - [ ] Genaue Alarm-Uhrzeiten festlegen
# - [ ] GitHub-Repo anlegen
# - [ ] Raspberry Pi einrichten (Betriebssystem flashen, WLAN von Opa konfigurieren)
# - [ ] Hardware-Test: Taster mit GPIO verkabeln, Test-Skript gibt Tastendruck in Konsole aus
